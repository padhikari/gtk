...
int main (int argc, char *argv[]){
	...
	// create the tree store, paasing in the number and type of each column	
	store = gtk_tree_store_new (N_COLUMNS, G_TYPE_STRING, G_TYPE_STRING, 
					G_TYPE_STRING);
	
	//next part adds a parent and child row to the tree
	...
	//add columns to the view, setting their data source and titles
