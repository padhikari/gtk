...
//two callback functions that are called when the window is destroyed and OK button is clicked
...
//use hbox and vbox container widgets to lay out the label and entry widgets
